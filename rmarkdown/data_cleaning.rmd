...
asthma <- read_rds("data/asthma_prevalence_2017_capcog.rds") |> 
    ...
    rename("Asthma ED incidence rate" = total_prev,
           "Asthma ED incidence rate in Children" = child_prev,
           "Asthma ED incidence rate in Adults" = adult_prev) |>
    pivot_longer(cols = `Asthma ED incidence rate in Children`:`Asthma ED incidence rate`,  
                 names_to = "var",
                 values_to = "value") 
